...
document.getElementById("result").innerHTML = 'Multiples of a or b below n: ' + result.toString();
...
function calculateFromUserInput() {
    ...
    document.getElementById('result').innerHTML = `Sum of multiples of ${a} or ${b} below ${n} is: ${result.toString()}`;
}
